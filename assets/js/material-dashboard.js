...
function sidebarColor(a) {
  ...
  var filter = document.getElementById("btnFilterData");

  var color = a.getAttribute("data-color");

  if (parent.classList.contains('bg-gradient-primary')) {
    parent.classList.remove('bg-gradient-primary');
    logout.classList.remove('bg-gradient-primary');
    filter.classList.remove('bg-gradient-primary');
  }
  if (parent.classList.contains('bg-gradient-dark')) {
    parent.classList.remove('bg-gradient-dark');
    logout.classList.remove('bg-gradient-dark');
    filter.classList.remove('bg-gradient-dark');
  }
  if (parent.classList.contains('bg-gradient-info')) {
    parent.classList.remove('bg-gradient-info');
    logout.classList.remove('bg-gradient-info');
    filter.classList.remove('bg-gradient-info');
  }
  if (parent.classList.contains('bg-gradient-success')) {
    parent.classList.remove('bg-gradient-success');
    logout.classList.remove('bg-gradient-success');
    filter.classList.remove('bg-gradient-success');
  }
  if (parent.classList.contains('bg-gradient-warning')) {
    parent.classList.remove('bg-gradient-warning');
    logout.classList.remove('bg-gradient-warning');
    filter.classList.remove('bg-gradient-warning');
  }
  if (parent.classList.contains('bg-gradient-danger')) {
    parent.classList.remove('bg-gradient-danger');
    logout.classList.remove('bg-gradient-danger');
    filter.classList.remove('bg-gradient-danger');
  }
  parent.classList.add('bg-gradient-' + color);
  logout.classList.add('bg-gradient-' + color);
  filter.classList.add('bg-gradient-' + color);
  localStorage.setItem('color', "bg-gradient-"+color);
}
...
function darkMode(el) {
  ...
  if (!el.getAttribute("checked")) {
    ...
    el.setAttribute("checked", "true");
    modal.classList.add("dark-version");
    ...
    if(modal.classList.contains('dark-version')){
      modal.classList.toggle("dark-version")
    }
  }
};